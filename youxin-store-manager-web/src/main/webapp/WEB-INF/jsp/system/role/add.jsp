    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="role.name" placeholder="角色名称" class="layui-input" value="" required  lay-verify="required" autocomplete="off"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="role.des" placeholder="角色描述" class="layui-input" value="" required  lay-verify="required" autocomplete="off"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="role.seq" placeholder="排序号" class="layui-input" value="" required  lay-verify="required" autocomplete="off"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select id='status' name="role.status" lay-verify="required">
                    <option></option>
                    #statusOption(io.jboot.admin.service.entity.status.system.RoleStatus::me(), '1')
                </select>
            </div>
        </div>
...
<script type="text/javascript">
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(sub)', function(data){
            ...
            util.sendAjax ({
                type: 'POST',
                url: '#(ctxPath)/system/role/postAdd',
